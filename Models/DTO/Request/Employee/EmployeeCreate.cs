...
public class EmployeeCreate
{
    ...
    public EmployeeCreate(string name, string code, string cCCD, EmployeeD status, int age, DateTime dob, Ethnic ethnic, Job job, string phone, DateTime createdDate, DateTime updatedDate, int activeCertificateCount, int totalCertificateCount, int idTinh, int idHuyen, int idXa)
    {
        Name = name;
        Code = code;
        CCCD = cCCD;
