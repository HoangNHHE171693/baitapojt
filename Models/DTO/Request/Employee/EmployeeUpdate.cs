...
public class EmployeeUpdate
{
    ...
    public EmployeeUpdate(int id, string name, string code, string cCCD, EmployeeD status, int age, DateTime dob, Ethnic ethnic, Job job, string phone, DateTime createdDate, DateTime updatedDate, int activeCertificateCount, int totalCertificateCount, int idTinh, int idHuyen, int idXa)
    {
        Id = id;
        Name = name;
        Code = code;
